...
class VacancyController extends Controller
{
    ...
    public function profilCandidate($id){
        ...
        'skills.skill', 'corp.user_id', 'education.graduate as lulusan', 'education.name as kampus', 'education.graduate', 'education.major', 'education.gpa', 'candidates.apply_jobs_id',
