...
<body>
    <div id="app">
        <div class="main-wrapper">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="{{ url('/jobs') }}"><i class="fa fa-building"></i><span>Jobs</span></a>
                        </li>
                        <li>
            ...
            {{--Date Picker--}}
            <link rel="stylesheet" href="//code.query.com/ui/1.11.4/themes/smoothness/jquery-ui.css">
            <script src="code.query.com/jquery-1.10.2.js"></script>
